...
const Skills = () => {
    ...
    const [indexIconSelect, setIndexIconSelect] = useState(1)
    ...
    const rotateIcons = () => {
        ...
        return icons.map((icon, index) => {
            ...
            if (comparacion <= numberItemSide) {
                return (
                    <>
                        <div key={icon.key} onClick={() => setIndexIconSelect(index)} className={`grid-item${comparacion === 0 ? " icon-front" : " icon-rendered"}`}>
